...
public class CollaboratorController {
    ...
    public ResponseEntity<ApiResponse> addCollaborator(
        ...
        try {
            CollaboratorResponseDTO collaborator =
                    collaboratorService.addCollaborator(noteId, dto, getEmail());
    ...
    public ResponseEntity<ApiResponse> getCollaborators(
            @PathVariable Long noteId) {
        try {
            List<CollaboratorResponseDTO> collaborators =
                    collaboratorService.getCollaborators(noteId, getEmail());
