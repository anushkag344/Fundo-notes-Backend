...
public interface NoteRepository extends JpaRepository<Note, Long> {
    ...
    // Get all notes associated with label ID regardless of user or status
    List<Note> findByLabels_Id(Long labelId);

    // Find notes where reminder time has passed and notification is not yet sent
    List<Note> findByReminderBeforeAndReminderSentFalseAndIsTrashedFalse(
